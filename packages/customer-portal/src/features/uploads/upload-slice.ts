...
export const { updateUserImage, update_cert_of_registration, update_DUNS_cert, update_IATA_cert,
  update_AEO_cert, update_pancard_auth, update_isoCertificate, update_aadhaar_card, update_pancard_company, update_manufacturing_license, update_other_license
} = uploadSlice.actions;
