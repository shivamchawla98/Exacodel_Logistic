...
function Descript() {
  return (
    <section className="h-screen  flex justify-center relative">
      <div className=" h-full w-4/5 absolute top-0 bg-sky-700">
        <Image
          src={image}
      ...
      <div className="absolute bottom-0 p-10 flex justify-center flex-col lg:pl-80  pb-36">
        <div>
          ...
          <p className="text-lg font-normal text-white lg:text-xl pr-36">
