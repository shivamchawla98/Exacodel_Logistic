...
function HotDeals() {
  ...
  return (
    <section className="pt-40 pb-40 bg-gradient-to-br from-white to-sky-100 w-full">
      <h1 className=" mb-4 text-3xl font-extrabold tracking-tight text-gray-800 leading-none md:text-3xl xl:text-5xl text-center flex justify-center">
        Hot{<FireIcon className="h-7 text-rose-400 " />} Deals
      </h1>

      {/* import Offer */}
      <h3 className="mb-4 text-xl font-semibold tracking-tight leading-none md:text-2xl xl:text-2xl text-center text-gray-700 pt-12">
        Import Offers
      </h3>
