...
import {    updateCompanyBillingCode,
    ...
    updateEmail,
    updateWebsite,
    updateCheckBox,} from '../../features/vendorRegForm/vendorReg-slice'
import {
  companyTypes,
  industryTypes,
  typeOfCompanies,
...
function VendorRegistrationForm() {
  ...
  return (
    <>
      ...
      >
        {({values}) => (
        <Form className="mt-2 grid lg:grid-cols-3 grid-cols-2 gap-6 lg:p-28 p-12 gap-y-8 w-full">
          {/* billing Code of a company */}
          <h2 className="text-xl font-semibold leading-7 col-span-3 py-6 text-gray-900 pl-11 pt-11">
