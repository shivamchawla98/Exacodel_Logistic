...
function ShippingFilter() {
  ...
  return (
    <form className="w-full flex-wrap flex justify-center item-center pt-12 pb-12">
      <div className="w-11/12 md:w-3/12 lg:w-3/12  relative mt-2 bg-white ml-2 mr-2 rounded-md shadow-sm px-3.5 py-2.5">
        ...
        <div
          id="suggestion"
          className="absolute z-20 mt-2 w-full overflow-hidden rounded-md bg-white"
        >
      ...
      <div className=" flex justify-center flex-col items-center">
        <button
          ...
          type="button"
          className="rounded-md w-1/4 h-12 mt-4 px-3 py-2 text-sm font-semibold text-white shadow-sm bg-rose-500 hover:bg-rose-400 items-center my-auto relative"
        >
          Book Now
        </button>
