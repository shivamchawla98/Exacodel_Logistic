function page() {
  return (
      <section className="relative z-10 overflow-x-hidden bg-white py-20 lg:py-[120px]">
        <div className="container mx-auto">
          <div className="-mx-4 flex flex-wrap lg:justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12 pl-7">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                <span className="text-primary mb-4 block text-base font-semibold pl-6">
                  Contact Us
                </span>
                <h2 className="pl-6 text-dark mb-6 text-[32px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px] text-blue-700">
                  GET IN TOUCH WITH US
                </h2>
                <p className="pl-6 text-body-color mb-9 text-base leading-relaxed">
                We would love to hear from you! If you have any questions, inquiries, or feedback, please feel free to reach out to us using the contact information provided below:
                </p>
