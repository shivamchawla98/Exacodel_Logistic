...
function Page() {
  ...
  const registerButtonClicked = useSelector(
    (state: any) => state.registerConfSlice.registerButtonClicked
  );
  ...
  return (
    <div className="">
      ...
      {formName === "registration" && identification === "CUSTOMER" && (
        <CustomerRegistrationForm />
      )}
      {formName === "registration" && identification === "VENDOR" && (
        <VendorRegistrationForm />
      )}
      {formName === "registration" && identification === "OVERSEAS_AGENT" && (
