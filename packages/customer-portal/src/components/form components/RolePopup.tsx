              ...
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                <div className="flex justify-end w-full">
                  <div
                    ...
                    className="w-10 h-10 flex justify-center items-center bg-fuchsia-200 rounded-full cursor-pointer"
                  >
                    <XMarkIcon className="w-6 h-6 text-primary-500 hover:text-fuchsia-800" />
                  </div>
                </div>

                <div className="border-primary-500 group inline-flex items-center border-b-2 py-2 px-1 text-base font-medium mb-10">
                ...
                <div className="mt-6">
                  ...
                  <select
                    id="userType"
                    name="userType"
                    className="block w-full bg-white rounded-md border-0 py-2.5 px-4 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-500 sm:text-sm sm:leading-6"
                    onChange={(e) => {
                ...
                <div className="w-full flex justify-center mt-6 mb-8">
                  <button
                    ...
                    className="w-4/5 mt-6 text-white bg-primary-500 hover:bg-fuchsia-800 focus:ring-4 focus:outline-none
               focus:ring-fuchsia-300 font-medium rounded-lg text-sm px-5 py-3.5 text-center dark:bg-primary-500 dark:hover:bg-primary-500 dark:focus:ring-fuchsia-800"
                  >
                    Go ahead and save
                  </button>
                </div>
