                            ...
                            <div className='col-span-2 flex justify-end'>
                              ...
                              <div >
                                ...
                                <Field
                                  ...
                                  className="block w-full rounded-md border-0 py-2.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-sky-600 sm:text-sm sm:leading-6 px-2 focus:outline-none"
                                >
                            ...
                            <div className="relative mt-2 rounded-md shadow-sm">
                              <div className="absolute inset-y-0 left-0 flex items-center">
                                ...
                                <Field
                                  ...
                                  className="w-12 h-full rounded-md border-0 bg-transparent py-0 text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-sky-600 sm:text-sm"
                                >
                                  <option value=""></option>
                              ...
                              <Field
                                ...
                                className="block text-center w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-sky-600 sm:text-sm sm:leading-6 px-2 focus:outline-none"
