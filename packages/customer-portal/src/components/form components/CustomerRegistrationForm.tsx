          ...
          <Form className="lg:p-16 grid lg:grid-cols-2 gap-6 p-12 gap-y-8">
            ...
            {!apiResponse && (
              <button
                ...
                className="mt-8 rounded-md bg-primary-500 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-fuchsia-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500"
              >
                Save GST
              </button>
            )}
                  ...
                  <div>
                    <label className="mx-6">
                      <Field
                        ...
                        className="w-4 h-4 text-primary-500 bg-gray-100 border-gray-300 rounded focus:ring-primary-500 dark:focus:ring-fuchsia-800 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                        type="radio"
              ...
              <hr className="my-6 h-0.5 col-span-3 border-t-0 bg-neutral-100 opacity-100 dark:opacity-50" /> */}
                ...
                <div className="end-end-2 col-span-full">
                  ...
                  <button
                    ...
                    className="mt-8 rounded-md bg-primary-500 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-primary-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-fuchsia-800"
                  >
                    Submit
                  </button>
                </div>
