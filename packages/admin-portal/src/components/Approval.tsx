    ...
    try {
      const { data: approvalData } = await approveUser({
        variables: {
          ...
          kycin: {
            certificate_of_registration: user.kyc.certificate_of_registration,
            company_pan_card: user.kyc.company_pan_card,
            aadhar_card: user.kyc.aadhar_card,
            pan_card: user.kyc.pan_card,
            iso_certificate: user.kyc.iso_certificate,
            aeo_certificate: user.kyc.aeo_certificate,
            iata_certificate: user.kyc.iata_certificate,
            duns_certificate: user.kyc.duns_certificate,
            manufacturing_license: user.kyc.manufacturing_license,
            any_other_trading_license: user.kyc.any_other_trading_license,
          },
        },
      });
