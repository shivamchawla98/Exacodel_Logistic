...
function WarehouseEdit({ Id, setActiveItem }: any) {
  ...
  useEffect(() => {
    if (!loading && data && data.getWarehouseById) {
      ...
      console.log("warehouse type : ", warehouse.temperatureCapacity, selectedTemperatureCapacities);
      ...
      if (warehouse) {
        ...
        setFormData({
          ...
          "Warehouse Type": warehouseTypeMapping[selectedWarehouseType] || selectedWarehouseType,
          ...
          "Temperature Capacity": temperatureCapacityMapping[selectedTemperatureCapacities] || selectedTemperatureCapacities
        });
                  ...
                  <div className="">
                    {label === 'Warehouse Type' ? (
                      ...
                      >
                        ...
                        {Object.entries(warehouseTypeMapping).map(([value, label]: any) => (
                      ...
                      >
                        ...
                        {Object.entries(temperatureCapacityMapping).map(([value, label]: any) => (
                          <option key={value} value={value}>
                            {label}
                          </option>
                        ))}
